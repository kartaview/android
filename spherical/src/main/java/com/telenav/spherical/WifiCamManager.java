...
import com.telenav.spherical.network.CameraConnector;
import com.telenav.spherical.network.CameraInfo;
import com.telenav.spherical.network.HttpEventListener;
import com.telenav.spherical.network.ImageData;
import com.telenav.spherical.network.ImageInfo;
import com.telenav.spherical.network.StorageInfo;
import com.telenav.spherical.view.ImageItem;
import com.telenav.spherical.view.JpegInputStream;
import com.telenav.spherical.view.WifiCamSurfaceView;
  ...
  public class LoadObjectListTask extends AsyncTask<Void, String, List<ImageItem>> {
    ...
    protected List<ImageItem> doInBackground(Void... params) {
      try {
        ...
        publishProgress(cameraInfo.getClass().getSimpleName() + ":<" + cameraInfo.getModel() + ", " + cameraInfo.getDeviceVersion() + ", " +
                            cameraInfo.getSerialNumber() + ">");
        ...
        for (int i = 0; i < objectSize; i++) {
          ...
          publishProgress("<ImageInfo: File ID=" + object.getFileId() + ", filename=" + object.getFileName() + ", capture_date=" +
                              object.getCaptureDate() + ", image_pix_width=" + object.getWidth() + ", image_pix_height=" +
                              object.getHeight() + ", object_format=" + object.getFileFormat() + ">");
    ...
    protected void onPostExecute(List<ImageItem> imageItems) {
      if (imageItems != null) {
        ...
        //
        //                ImageListArrayAdapter imageListArrayAdapter = new ImageListArrayAdapter(ImageListActivity.this, R.layout
        // .listlayout_object, imageItems);
        ...
        //                            GLPhotoActivity.startActivityForResult(ImageListActivity.this, cameraIpAddress, fileId, thumbnail,
        // false);
        //                        } else {
