 ...
 * <ul>
 * <li>{@link #saveLocation(OSVLocation, String, String)}</li>
...
public interface LocationLocalDataSource {
     ...
     * @param osvLocation the custom {@code location} representing the data to be persisted.
     ...
     */
    boolean saveLocation(@NonNull OSVLocation osvLocation, @Nullable String videoID, @Nullable String frameID);
     ...
     */
    Single<List<OSVLocation>> getLocations();
     ...
     */
    Maybe<List<OSVLocation>> getLocationsBySequenceId(@NonNull String sequenceID);
     ...
     */
    Maybe<List<OSVLocation>> getLocationsByVideoId(@NonNull String videoID);

    /**
     * @param locationID the {@code identifier} of the location.
     * @return {@code location} identified by given parameter.
     */
    Maybe<OSVLocation> getLocationById(@NonNull String locationID);

    /**
     * @param frameID the {@code identifier} representing the frame to which the location correspond to.
     * @return {@code location} identified by given parameter.
     */
    Maybe<OSVLocation> getLocationByFrameId(@NonNull String frameID);
