...
public class BackgroundThreadPool {
  ...
  private BackgroundThreadPool() {
    ...
    mThreadPoolExec = new ThreadPoolExecutor(coreNum, coreNum, KEEP_ALIVE, TimeUnit.SECONDS, workQueue,
                                             new ThreadFactoryBuilder().setDaemon(false).setNameFormat("BackgroundThreadPool")
