...
public class FormatUtils {
     ...
     */
    public static String[] fromDistanceFromMetersToUnit(boolean isImperial, double distInMetersPerSeconds) {
    ...
    public static String getMetadataFormatTimestampFromLong(long mTimeStamp) {
        ...
        return String.format(Locale.getDefault(), METADATA_TIMESTAMP_FORMAT, number);
    }
    ...
    public static String getDistanceUnitLabel(Context context, String separator, boolean isShortDistance) {
        if (!((OSVApplication) context.getApplicationContext()).getAppPrefs().getBooleanPreference(PreferenceTypes.K_DISTANCE_UNIT_METRIC)) {
