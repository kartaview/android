...
public class GeometryRetriever extends NetworkManager implements Response.ErrorListener {
     ...
     */
    public void listSegments(final NetworkResponseDataListener<GeometryCollection> listener, final String upperLeft, final String lowerRight, final float
            zoom) {
        ...
        ListTracksRequest seqRequest = new ListTracksRequest(URL_LIST_TRACKS, new OsvRequestResponseListener<GeometryParser, GeometryCollection>(mGeometryParser) {
    ...
    public void nearby(final NetworkResponseDataListener<TrackCollection> listener, String lat, String lon) {
        NearbyRequest seqRequest = new NearbyRequest(URL_NEARBY_TRACKS, new OsvRequestResponseListener<NearbyTracksParser, TrackCollection>(mNearbyTracksParser) {
