...
//        if (isNewApiCompatible() && ((OSVApplication) context.getApplicationContext()).getAppPrefs().getBooleanPreference(PreferenceTypes.K_USE_CAMERA_API_NEW)) {
...
//        }
    ...
    public abstract void takeSnapshot(final ShutterCallback shutterCallback, final ImageReadyCallback jpeg,
...
//        Log.d(TAG, "focusOnTouch: surfaceWidth=" + surfaceWidth + ", surfaceHeight=" + surfaceHeight + ", radius=" + radius + ", x=" + x + ", y=" + y);
