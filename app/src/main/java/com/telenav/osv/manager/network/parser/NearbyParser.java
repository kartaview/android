...
public class NearbyParser extends ApiResponseParser<TrackCollection> {
            ...
            try {
                ...
                if (array1.length() > 0) {
                    for (int i = 0; i < array1.length(); i++) {
                        ...
                        SequenceDetailsCompressionJpeg compressionJpeg = getJpegCompression(item);
    ...
    SequenceDetailsCompressionJpeg getJpegCompression(JSONObject sequenceJsonFormat) throws JSONException {
        ...
        String thumbLink = UserDataManager.URL_DOWNLOAD_PHOTO + sequenceJsonFormat.getString("photo");
