        ...
        try {
            ...
            if (collectionData.getTotalFilteredItems() > 0) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    DriverOnlineSequence seq = new DriverOnlineSequence(id, date, Integer.valueOf(imgNum), partialAddress, thumbLink, obd, platform, platformVersion, appVersion,
                            (int) (distanceNum
                            * 1000d), value, currency);
