...
public class DataConsistency {
    ...
    private void sequenceDataConsistency(@NonNull SequenceDetailsLocal sequenceDetailsLocal, @NonNull SequenceDetails sequenceDetails, @NonNull String sequenceId) {
        ...
        int frameNo = frameLocalDataSource.getFrameCountBySequenceId(sequenceId);
    ...
    private void updateDistanceForSequenceId(SequenceDetails sequenceDetails, String sequenceId) {
        List<OSVLocation> sequenceLocations = locationLocalDataSource.getLocationsBySequenceId(sequenceId).blockingGet();
    ...
    private boolean isFileAbsent(String path) {
        return !new OSVFile(path).exists();
    }

    /**
     * Removes the sequence folder and all its children by internally calling {@link OSVFile#delete()} method.
     */
    private void removeSequence(OSVFile file, String sequenceId) {
