...
public class DriverOnlineSequence extends OnlineSequence {
    ...
    public DriverOnlineSequence(int sequenceId, Date date, int originalImageCount, String address, String thumbLink, boolean obd, String platform, String platformVersion,
                                String appVersion, int distance, double value, String currency) {
