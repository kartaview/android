 ...
 * </ul>
 * The whole process needs to be initialised before signaling events by using {@link #initTagging(KVFile)} and also needs be released of resources by using
 * {@link #finish(String, SequenceDetailsLocal)}.
 */
public interface RecordingTaggingLogger {
     ...
     */
    void initTagging(KVFile sequenceFolder);
