...
public abstract class TaggingBase<T extends JsonElement> {
    ...
    public static final String PROPERTY_VALUE_OSC_TAGGING_NOTE = "NOTE";

    public static final String PROPERTY_VALUE_OSC_TAGGING_NARROW_ROAD = "NARROW ROAD";

    public static final String PROPERTY_VALUE_OSC_TAGGING_CLOSED_ROAD = "CLOSED ROAD";

    public static final String PROPERTY_VALUE_ONE_WAY_YES = "YES";

    public static final String PROPERTY_VALUE_OSC_TAGGING_ONE_WAY = "ONE WAY";

    public static final String PROPERTY_VALUE_OSC_TAGGING_TWO_WAY = "TWO WAY";
    ...
    public static final String PROPERTY_NAME_OSC_TAGGING = "osc_tagging";
    ...
    @StringDef(value = {PROPERTY_VALUE_OSC_TAGGING_CLOSED_ROAD, PROPERTY_VALUE_OSC_TAGGING_NARROW_ROAD, PROPERTY_VALUE_OSC_TAGGING_NOTE})
    public @interface EventType {

    }

    @Retention(RetentionPolicy.SOURCE)
    @StringDef(value = {PROPERTY_VALUE_OSC_TAGGING_ONE_WAY, PROPERTY_VALUE_OSC_TAGGING_TWO_WAY})
