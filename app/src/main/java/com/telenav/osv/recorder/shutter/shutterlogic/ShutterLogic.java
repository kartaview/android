...
public abstract class ShutterLogic {
    ...
    public void onLocationChanged(Location location) {
        currentCachedLocation = location;
    }
    ...
    protected boolean isCurrentLocationValid() {
        return currentCachedLocation != null && currentCachedLocation.getLatitude() != 0.0 && currentCachedLocation.getLongitude() != 0.0;
    }
