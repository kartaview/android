...
public class RecordingTaggingLoggerImpl implements RecordingTaggingLogger {
     ...
     */
    private OSVFile recordingTxtFile;
    ...
    @Override
    public void initTagging(OSVFile sequenceFolder) {
        sensorDataQueue = new ConcurrentLinkedQueue<>();
        this.sequenceFolder = sequenceFolder;
        try {
            recordingTxtFile = new OSVFile(sequenceFolder, RECORDING_TAGGING_FILE_NAME_TXT);
