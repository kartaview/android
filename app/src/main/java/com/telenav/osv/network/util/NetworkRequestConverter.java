...
public class NetworkRequestConverter {
    ...
    public static MultipartBody.Part generateFilePart(String name, KVFile file, boolean isZip) {
     ...
     */
    public static MultipartBody.Part generateMultipartBodyPart(@MediaTypesDef String type, String name, KVFile file, @Nullable ProgressRequestListener progressRequestListener) {
