...
public class ObdConnectedPresenterImpl implements ObdConnectedPresenter {
    ...
    ObdConnectedPresenterImpl(ObdConnectedView view, ApplicationPreferences applicationPreferences, ObdManager obdManager,
        ...
        isScoreEnabled = applicationPreferences.getIntPreference(PreferenceTypes.K_USER_TYPE) != PreferenceTypes.USER_TYPE_BYOD
                && applicationPreferences.getBooleanPreference(PreferenceTypes.K_GAMIFICATION);
        if (isScoreEnabled) {
