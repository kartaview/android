...
public class ConnectToObdFragment extends ObdBaseFragment implements ConnectToObdContract.ConnectToObdView {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new ConnectToObdPresenterImpl(this, ((OSVApplication) getActivity().getApplication()).getAppPrefs());
    }
    ...
    @Override
    public void displayFragment(OSCBaseFragment fragment, String tag) {
    ...
    private void initObdRewardLabel(View view) {
        ...
        if (presenter.isByod()) {
            textView.setText(R.string.obd_connect_earn_double_the_pay_rate);
        } else {
