...
public class ByodProfileFragment extends ProfileFragment implements TabLayout.OnTabSelectedListener {
        ...
        if (view != null) {
            ...
            mTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
                ...
                public void onTabSelected(TabLayout.Tab tab) {
                    ...
                    mSequencesRecyclerView.setLayoutManager(portrait ? mPortraitLayoutManager : (mCurrentDataSource == DATA_SOURCE_TRACKS ? mLandscapeLayoutManager :
                    ...
                    if ((mCurrentDataSource == DATA_SOURCE_PAYMENTS && mPaymentCurrentPageToList == 1) || (mCurrentDataSource == DATA_SOURCE_TRACKS && mCurrentPageToList == 1)) {
                        refreshContent();
                    }
                }
    ...
    protected void displayCachedStats() {
        ...
        final String[] currentAccepted = Utils.formatDistanceFromKiloMeters(activity, prefs.getFloat(ProfileFragment.K_DRIVER_CURRENT_ACCEPTED_DISTANCE, 0));
        ...
        final String[] accepted = Utils.formatDistanceFromKiloMeters(activity, prefs.getFloat(ProfileFragment.K_DRIVER_TOTAL_ACCEPTED_DISTANCE, 0));
        final String[] rejected = Utils.formatDistanceFromKiloMeters(activity, prefs.getFloat(ProfileFragment.K_DRIVER_TOTAL_REJECTED_DISTANCE, 0));
        final String[] obdDistance = Utils.formatDistanceFromKiloMeters(activity, prefs.getFloat(ProfileFragment.K_DRIVER_TOTAL_OBD_DISTANCE, 0));
        ...
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                fillUserInformation(name, username, photoUrl, currentAccepted, rate, value, accepted, rejected, obdDistance, photos, tracks, totalValue, currency);
    ...
    protected RecyclerView.LayoutManager getLayoutManager(boolean portrait) {
        return portrait ? mPortraitLayoutManager : (mCurrentDataSource == DATA_SOURCE_PAYMENTS ? mPortraitLayoutManager : mLandscapeLayoutManager);
    }
...
//                                mCurrentPageToList--;
                ...
                if (driverData != null) {
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            fillUserInformation(name, username, photoUrl, currentAccepted, rate, value, acceptedDistance, rejectedDistance, obdDistance, totalPhotos,
                                    totalTracks, driverData.getTotalPaidValue(), currency);
                        }
                    });
                }
            }
    ...
    private void fillUserInformation(String name, String username, String photoUrl, String[] currentAccepted, String rate, String value, String[] acceptedDistance,
                                     String[] rejectedDistance, String[] obdDistance, String totalPhotos, String totalTracks, double paymentValue, String currency) {
