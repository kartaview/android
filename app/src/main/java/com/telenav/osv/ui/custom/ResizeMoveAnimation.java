...
public class ResizeMoveAnimation extends Animation {
  ...
  public ResizeMoveAnimation(View v, float fromWidth, float fromHeight, float toWidth, float toHeight, float fromPaddingTop,
                             float fromPaddingLeft, float fromPaddingBottom, float fromPaddingRight, float toPaddingTop,
                             float toPaddingLeft, float toPaddingBottom, float toPaddingRight) {
    mToHeight = toHeight;
    mToWidth = toWidth;
