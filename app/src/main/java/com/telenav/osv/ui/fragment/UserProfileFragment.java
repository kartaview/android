...
public class UserProfileFragment extends SimpleProfileFragment {
    ...
    protected void displayCachedStats() {
        ...
        fillUserInformation(name, username, photoUrl, score, rank, level, xpTarget, xpProgress, totalDistanceFormatted, obdDistanceFormatted, photos, tracks, true);
    }
        ...
        activity.getUserDataManager().getUserProfileDetails(new NetworkResponseDataListener<UserData>() {
            ...
            public void requestFinished(int status, final UserData userData) {
                ...
                if (userData != null) {
                    ...
                    final String photoUrl = appPrefs.getStringPreference(PreferenceTypes.K_USER_PHOTO_URL);
                    fillUserInformation(displayName, username, photoUrl, finalScore, finalRank, finalLevel, finalXpTarget,
                            finalXpProgress, totalDistanceFormatted, obdDistanceFormatted, totalPhotos, totalTracks, false);
                }
            }
        });
    }

    private void fillUserInformation(final String name, final String username, final String photoUrl, final int score, final int rank, final int level,
                                     final int xpTarget, final int xpProgress, final String[] totalDistanceFormatted, final String[] obdDistanceFormatted,
                                     final String photos, final String tracks, final boolean fromCache) {
