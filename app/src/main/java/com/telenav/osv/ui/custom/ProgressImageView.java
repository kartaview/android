...
public class ProgressImageView extends CircleImageView {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.ProgressImageView_piv_circleRadius, circleRadius);
        ...
        float baseSpinSpeed =
                a.getFloat(R.styleable.ProgressImageView_piv_spinSpeed, spinSpeed / 360.0f);
        ...
        barSpinCycleTime =
                a.getInt(R.styleable.ProgressImageView_piv_barSpinCycleTime, (int) barSpinCycleTime);
