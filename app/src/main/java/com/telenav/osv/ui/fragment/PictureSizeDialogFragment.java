    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ok_button_selection:
                if (widthSize != preferences.getIntPreference(PreferenceTypes.K_RESOLUTION_WIDTH) || heightSize != preferences.getIntPreference(PreferenceTypes
                        .K_RESOLUTION_HEIGHT)) {
                    ...
                    Log.d(TAG, "Resolution when press OK: " + preferences.getIntPreference(PreferenceTypes.K_RESOLUTION_WIDTH) + " x " + preferences.getIntPreference
