...
public class KVTooltip {
    ...
    public static class Builder {
        ...
        /**
         * Creates a {@link KVTooltip} with the given properties through this builder, without showing the tooltip.
         *
         * @return {@link KVTooltip} instance.
         */
        ...
        /**
         * Builds and shows a {@link KVTooltip} with the given properties through this builder.
         *
         * @param showWithAnimation if the flag is set to true the tooltip displaying will be animated with a fade in animation.
         * @return {@link KVTooltip} instance.
         */
        public KVTooltip show(boolean showWithAnimation) {
            KVTooltip tooltip = build();
