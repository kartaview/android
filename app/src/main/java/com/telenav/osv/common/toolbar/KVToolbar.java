 ...
 * <ul>
 * <li>{@link KVToolbar#updateToolbar(ToolbarSettings)}</li>
 * <li>{@link KVToolbar#setTitle(String)}</li>
 * <li>{@link KVToolbar#setTitle(int)}</li>
 * <li>{@link KVToolbar#showToolbar()}</li>
 * <li>{@link KVToolbar#hideToolbar()}</li>
 * <li>{@link KVToolbar#addMenu(int, SparseArray)}</li>
 * </ul>
 *
 * @see ToolbarSettings
 */
public class KVToolbar {
     ...
     * This value can be modified by updating the toolbar using {@link KVToolbar#updateToolbar(ToolbarSettings)} method
     ...
     */
    public KVToolbar(Toolbar toolbar, View.OnClickListener navigationClickListener) {
