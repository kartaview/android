 ...
 * </ul>
 */
public abstract class OSVServiceConnection<T extends OscBaseService, G extends OscBaseBinder> implements ServiceConnection {

    /**
     * The {@code String} representing the TAG of the current class.
     */
    public final String TAG = OSVServiceConnection.class.getSimpleName();
