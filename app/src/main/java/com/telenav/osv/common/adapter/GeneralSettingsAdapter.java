...
public class GeneralSettingsAdapter extends RecyclerView.Adapter<GeneralSettingsAdapter.GeneralSettingsViewHolder> {
    ...
    public GeneralSettingsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ItemViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.partial_osc_setting_item, parent, false));
    }
    ...
    private void resetViewHolderLayout(ItemViewHolder holder) {
        ...
        ViewGroup.LayoutParams params = holder.layout.getLayoutParams();
        params.height = (int) context.getResources().getDimension(R.dimen.partial_osc_setting_item);
        params.width = ViewGroup.LayoutParams.MATCH_PARENT;
        holder.layout.setLayoutParams(params);
    }
    ...
    class ItemViewHolder extends GeneralSettingsViewHolder {
        ...
        ItemViewHolder(View itemView) {
            ...
            title = itemView.findViewById(R.id.text_view_osc_setting_item_title);
            subtitle = itemView.findViewById(R.id.text_view_osc_setting_item_subtitle);
            leftIcon = itemView.findViewById(R.id.image_view_osc_setting_item_left_icon);
            rightIcon = itemView.findViewById(R.id.image_view_osc_setting_item_right_icon);
            layout = itemView.findViewById(R.id.layout_partial_osc_setting_item);
            divider = itemView.findViewById(R.id.view_osc_setting_item_divider);
            progressBar = itemView.findViewById(R.id.progress_bar_osc_setting_item_loader);
        }
    }
