...
public class VideoRequest<T> extends StringRequest {
    ...
    public VideoRequest(String url, GenericResponseListener listener, ProgressiveEntity.DataProgressListener dataProgressListener,
                        String token, OSVFile videoFile, long sequenceID, int sequenceIndex, Handler responseHandler) {
