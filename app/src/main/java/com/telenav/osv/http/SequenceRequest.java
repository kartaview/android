...
public class SequenceRequest<T> extends StringRequest {
    ...
    public SequenceRequest(String url, GenericResponseListener listener, ProgressiveEntity.DataProgressListener dataProgressListener, String token, String startCoord, OSVFile
            file, String appVersion, boolean obd, int score, String scoreDetails, Handler responseHandler) {
