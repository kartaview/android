    ...
    public boolean onStartJob(JobParameters params) {
        ...
        BackgroundThreadPool.post(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "onStartJob: isnet " + isNet + " iswifi " + isWifi + " localfiles " + localFilesExist + " dataset " + dataSet + " autoset " + autoSet +
                        " isrec " + isrecording);
    ...
    private void uploadStarted() {
        ...
        synchronized (notificationSyncObject) {
            ...
            mNotification = new NotificationCompat.Builder(this)
                    ...
                    .setColor(getResources().getColor(R.color.accent_material_dark_1))
                    .setWhen(0)
