...
public class ConnectionClassManager {
  ...
  /*package*/ static final double DEFAULT_SAMPLES_TO_QUALITY_CHANGE = 3;
  ...
  public synchronized void addBandwidth(long bytes, long timeInMs) {
    ...
    if (mNextBandwidthConnectionQuality != null) {
      mSampleCounter += 1;
  ...
  private void notifyListeners() {
    ...
    for (int i = 0; i < size; i++) {
      mListenerList.get(i).onBandwidthStateChange(mCurrentBandwidthConnectionQuality.get(), getCurrentBandwidth());
    }
  }
  ...
  public interface ConnectionClassStateChangeListener {
     ...
     */
    void onBandwidthStateChange(ConnectionQuality bandwidthState, double bandwidth);
  }
