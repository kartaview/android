...
public class Bioinspired {
    ...
    //
    // C++:  Ptr_Retina createRetina(Size inputSize, bool colorMode, int colorSamplingMethod = RETINA_COLOR_BAYER, bool useRetinaLogSampling = false, float reductionFactor =
    // 1.0f, float samplingStrenght = 10.0f)
    //
    ...
    // C++:  Ptr_Retina createRetina(Size inputSize, bool colorMode, int colorSamplingMethod = RETINA_COLOR_BAYER, bool useRetinaLogSampling = false, float reductionFactor =
    // 1.0f, float samplingStrenght = 10.0f)
    private static native long createRetina_0(double inputSize_width, double inputSize_height, boolean colorMode, int colorSamplingMethod, boolean useRetinaLogSampling, float
            reductionFactor, float samplingStrenght);
