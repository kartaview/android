...
TARGET_ARMEABI_DIR=$WORKING_DIR/../jniLibs/ffmpeg-android/armeabi
TARGET_ARMEABIV7A_DIR=$WORKING_DIR/ffmpeg-android/armeabi-v7a
#TARGET_ARMEABIV7N_DIR=$WORKING_DIR/ffmpeg-android/armeabi-v7a-neon
TARGET_X86_DIR=$WORKING_DIR/ffmpeg-android/x86
#TARGET_MIPS_DIR=$WORKING_DIR/ffmpeg-android/mips
#TARGET_X86_64_DIR=$WORKING_DIR/ffmpeg-android/x86_64
...
if [ ! -d $TARGET_ARMEABIV7A_DIR ]; then
    ...
    cd $WORKING_DIR
    ./build_ffmpeg.sh armeabi-v7a
fi

if [ ! -d $TARGET_ARMEABIV7N_DIR ]; then
    # Build FFmpeg from ARM v7 architecture and copy to the JNI folder
    cd $WORKING_DIR
    ./build_ffmpeg.sh armeabi-v7a-neon
fi
