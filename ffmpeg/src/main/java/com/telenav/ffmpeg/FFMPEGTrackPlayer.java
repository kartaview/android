...
public class FFMPEGTrackPlayer {
  ...
  private static final String[] JNI_LIBRARIES =
      {"SDL2", "avutil", "swscale", "avfilter", "avcodec", "avformat", "swresample", "SDL2", "encode"};
  ...
  private native void _setDataSource(String[] paths) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;
