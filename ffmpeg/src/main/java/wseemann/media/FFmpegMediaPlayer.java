 ...
 * <a href="{@docRoot}guide/topics/wseemann.media/mediaplayer.html">Media Playback</a> developer guide.</p>
 * </div>
 *
 ...
 *         setOnErrorListener(android.wseemann.media.MediaPlayer.OnErrorListener)}.
 *         <ul>
 ...
 *         OnPreparedListener is registered beforehand via setOnPreparedListener(android.wseemann.media.MediaPlayer.OnPreparedListener)}.</li>
 ...
 * styleable#AndroidManifestUsesPermission &lt;uses-permission
 * element.
 *
...
public class FFmpegMediaPlayer
{
    ...
    // Name of the remote interface for the wseemann.media player. Must be kept
    // in sync with the 2nd parameter of the IMPLEMENT_META_INTERFACE
    // macro invocation in IMediaPlayer.cpp
    private final static String IMEDIA_PLAYER = "wseemann.wseemann.media.IMediaPlayer";
    ...
    /**
     * Create a request parcel which can be routed to the native wseemann.media
...
//    public void setNextPlayer(FFmpegMediaPlayer player){
//        mNextPlayer = player;
//    }
//
//    public FFmpegMediaPlayer getNextPlayer(){
//        return mNextPlayer;
//    }
    ...
    /**
     * Gets the wseemann.media metadata.
     *
     ...
     * The wseemann.media framework will attempt to transition from this player to
     ...
     * this effect will be applied only to the audio content of wseemann.media players within the same
     ...
     * their counterparts in include/wseemann.media/mediaplayer.h!
     */
    /*
    ...
    // But if any keys are defined, the order must be kept in sync with include/wseemann.media/mediaplayer.h.
    ...
    /**
     * @param request Parcel destinated to the wseemann.media player. The
    ...
    /**
     * request Parcel with the 2 serialized lists of allowed
     ...
     * in include/wseemann.media/mediaplayer.h!
     */
    /** Unspecified wseemann.media player error.
     ...
     * in include/wseemann.media/mediaplayer.h!
     */
    /** Unspecified wseemann.media player info.
    ...
    /** Bad interleaving means that a wseemann.media has been improperly interleaved or
    ...
    /** The wseemann.media cannot be seeked (e.g live stream)
     * @see MediaPlayer.OnInfoListener
     */
