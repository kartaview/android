...
/**
   Class to hold the wseemann.media's metadata.  Metadata are used
   for human consumption and can be embedded in the wseemann.media (e.g
...
public class Metadata
{
    ...
    //private static final String TAG = "wseemann.media.Metadata";
